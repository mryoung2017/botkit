...
var storage = require(__dirname + '/storage/storage.js');
...
function Botkit(configuration) {
                    ...
                    if (this.messages.length) {
                        ...
                        if (typeof(this.messages[0].timestamp) == 'undefined' ||
                            ...
                            if (message.text || message.attachments || message.attachment) {
                                ...
                                this.task.bot.replyWithTyping(this.source_message, outbound, function(err, sent_message) {
                                    if (err) {
    ...
    botkit.storage = {
        sessions: {
            ...
            all: function(cb) {
                cb(null, botkit.memory_store.sessions);
            }
        },
        users: {
    ...
    **/
    ...
    if (configuration.storage) {
        ...
        botkit.storage = storage({path: configuration.json_file_store});
    } else {
